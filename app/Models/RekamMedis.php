...
class RekamMedis extends Model
{
    ...
    protected $fillable = ['created_at', 'anamnesa', 'temuan_klinis', 'diagnosa', 'idreservasi_dokter', 'idpet', 'dokter_pemeriksa'];
    ...
    {
        return $this->belongsTo(UserRole::class, 'dokter_pemeriksa', 'idrole_user');
    }
}
